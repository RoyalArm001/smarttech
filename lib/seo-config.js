...
const routeSeo = {
  ...
  services: {
    ...
    description: "Տեսահսկում, հրդեհային ազդարարում, մուտքի վերահսկում, ցանցեր, էլեկտրամոնտաժ, շենքերի ավտոմատացում և 24/7 մոնիթորինգ՝ SMS ահազանգումներով, նախագծումից մինչև տեղադրում ու սպասարձում։",
