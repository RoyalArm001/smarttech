...
const organization = {
  ...
  url: siteUrl + "/",
  description: "Smart Tech LLC provides electrical installation, CCTV, fire alarm, access control, network infrastructure and building automation services in Yerevan and across Armenia.",
  logo: defaultImage,
  image: defaultImage,
...
const services = [
  ...
  "Համակարգերի մոնիթորինգ և տեխնիկական սպասարկում"
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Գրասենյակը Երևանում է։ Ծառայություններ ենք մատուցում Երևանում և Հայաստանի մարզերում՝ ըստ նախագծի պահանջների։"
  },
  {
...
const routeSeo = {
  index: {
    path: "/",
    canonicalPath: "/",
    title: "Smart Tech | Անվտանգության համակարգեր և էլեկտրամոնտաժ Հայաստանում",
    description: "Տեսահսկում, հրդեհային ազդարարում, մուտքի վերահսկում, ցանցեր, էլեկտրամոնտաժ և շենքերի ավտոմատացում Երևանում ու Հայաստանում։ Smart Tech՝ նախագծումից մինչև սպասարկում։",
...
function seoHead(route) {
  ...
  if (!/noindex/i.test(robots)) robots += ", max-image-preview:large, max-snippet:-1, max-video-preview:-1";
...
function robotsTxt() {
  return [
    ...
    "",
    "# Detail-page id parameters identify distinct content; do not strip them.",
    "",
