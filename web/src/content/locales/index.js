(function (site) {
  site.content.locales = {
    hy: {
      ...
      detail: {
        ...
        galleryEyebrow: "Նկարներ",
        galleryTitle: "Նկարների հավաքածու",
        galleryText: "Ընտրված նկարների հավաքածու՝ ծառայության կամ նախագծի մասշտաբը ավելի պարզ ներկայացնելու համար։",
      ...
      team: {
        "it-director": { title: "IT Director", text: "Պատասխանատու է ցանցերի, սերվերային ենթակառուցվածքի, ինտեգրացիաների և տեխնիկական ճարտարապետության համար։" },
        ...
        "alarm-system-manager": { title: "Alarm System Manager", text: "Ղեկավարում է ազդարարման, հրդեհային անվտանգության և տարհանման համակարգերի նախագծումն ու կարգաբերումը։" },
        "electricity-manager": { title: "Electricity Manager", text: "Վերահսկում է էլեկտրամոնտաժային աշխատանքները, բաշխիչ վահանները, լուսավորությունն ու մալուխային ուղիները։" }
      }
    },
    en: {
      code: "en",
      ...
      detail: {
        ...
        galleryEyebrow: "Images",
        galleryTitle: "Image collection",
        galleryText: "Selected images that show the scale and details of the service or project.",
      ...
      team: {
        ...
        "procurement-head": { title: "Head of Procurement", text: "Manages equipment purchasing, supplier selection and material supply for projects." },
    ...
    ru: {
      ...
      detail: {
        ...
        galleryEyebrow: "Изображения",
        galleryTitle: "Галерея изображений",
        galleryText: "Подборка изображений, которая показывает масштаб и детали услуги или проекта.",
      ...
      services: {
        ...
        "systems-design": { title: "Проектирование систем", lead: "Проектирование, расчет и интеграция инженерных систем для надежной работы объекта.", tags: ["Проектирование", "Расчет", "Интеграция систем"] },
      ...
      team: {
        "it-director": { title: "IT Director", text: "Отвечает за сети, серверную инфраструктуру, интеграции и техническую архитектуру." },
        ...
        "alarm-system-manager": { title: "Alarm System Manager", text: "Руководит проектированием и настройкой систем сигнализации, пожарной безопасности и эвакуации." },
        "electricity-manager": { title: "Electricity Manager", text: "Контролирует электромонтаж, распределительные щиты, освещение и кабельные трассы." }
      }
    }
  };
  ...
  site.content.locales.hy.team = Object.assign({}, site.content.locales.hy.team, {
    ...
    "procurement-head": { title: "Գնումների բաժնի ղեկավար", text: "Կառավարում է սարքավորումների գնումները, մատակարարների ընտրությունը և նախագծերի նյութական ապահովումը։" },
  ...
  site.content.locales.ru.team = Object.assign({}, site.content.locales.ru.team, {
    ...
    "procurement-head": { title: "Руководитель отдела закупок", text: "Управляет закупками оборудования, выбором поставщиков и материальным обеспечением проектов." },
